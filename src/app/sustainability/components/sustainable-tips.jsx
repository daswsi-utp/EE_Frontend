...
const GREEN_TIPS = [
  {
    ...
    shareText:
      "¡Recuerda reciclar todos los envases y enjuagarlos antes! #ConsejoEco",
    icon: "♻️",
  },
  {
    ...
    shareText:
      "¡Guarda bien tus productos eco para que duren más y reducir el desperdicio! #VidaSostenible",
    icon: "🧊",
  },
  {
    ...
    shareText:
      "¡Reutiliza frascos y botellas para almacenamiento creativo o manualidades! #ConsejoVerde",
    icon: "🫙",
  },
  {
    ...
    shareText:
      "¡Composta empaques biodegradables para ayudar al planeta! #EcoBrilla",
    icon: "🌱",
  },
];
...
export default function SustainableTips() {
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 text-white bg-teal-600">
                ...
                <button
                  ...
                  onClick={() => {
                    navigator.clipboard.writeText(
                      `${tip.shareText} ${window.location.href}`
                    );
                  }}
                  type="button"
                >
