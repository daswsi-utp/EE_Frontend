const SUPPLIERS = [
  {
    ...
    practices:
      "Cultivo sin pesticidas, riego eficiente, apoyo a comunidades locales",
  },
  {
    ...
    practices:
      "Recolección de botellas post-consumo, energía renovable, economía circular",
  },
  {
    ...
    practices:
      "Rotación de cultivos, manejo responsable del agua, comercio justo",
  },
  {
    ...
    practices:
      "Recolección sostenible, conservación de la biodiversidad, empleo local",
  },
  {
    ...
    material: "Poliéster Reciclado",
    practices:
      "Reciclaje de redes de pesca, reducción de emisiones, inclusión social",
  },
  {
    name: "HempLatam",
    country: "Uruguay",
    ...
    practices:
      "Agricultura regenerativa, sin agroquímicos, apoyo a pequeños productores",
  },
];
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-8">
          Nos asociamos con proveedores responsables y transparentes en todo el
          mundo. Explora el origen de nuestros materiales y las prácticas
          sostenibles detrás de ellos.
        </p>
            ...
            <tbody>
              {SUPPLIERS.map((supplier, i) => (
                ...
                >
                  ...
                  <td className="py-3 px-6 text-teal-800">
                    {supplier.country}
                  </td>
        ...
        <p className="text-xs text-gray-400 mt-4 text-center">
          * Todos los proveedores son auditados anualmente por estándares
