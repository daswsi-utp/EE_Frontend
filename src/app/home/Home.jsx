    ...
    <>
      <section className={`h-[88vh] max-w-[1280px] m-auto`}>
        <div className="grid grid-cols-5 grid-rows-6 gap-6 p-6 h-full text-white">
          <div
            className="col-span-4 bg-cover bg-center row-span-4 rounded-lg relative"
          ...
          >
            ...
            <div className="z-20 relative flex justify-center items-center h-full w-full pl-20">
              <p className="text-white text-[3.5rem]">
                Transforma tu vida con productos 100% ecológicosd
              </p>
            </div>
          </div>
          ...
          <div
            className="relative row-span-3 col-start-5 row-start-1 rounded-lg bg-no-repeat bg-center"
            style={{
          ...
          <div
            className="relative row-span-3 col-start-5 row-start-4 bg-black rounded-lg bg-cover bg-center flex items-end"
          ...
          <div
            className="relative col-span-2 row-span-2 col-start-3 row-start-5 rounded-lg bg-cover flex items-end"
