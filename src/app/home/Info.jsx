...
const Info = () => {
  return (
    <section className="w-full bg-tertiary overflow-hidden p-10 flex gap-20 justify-center items-center">
      <Card
        url="./Img/bambu.jpg"
      ...
      />
      <Card
        url="./Img/EmpaquesEcoAmigables.jpg"
